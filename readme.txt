   ...
   En el siguiente programas tenemos 6 opciones para comenzar a operar se requiere crear el archivo de propiedades en primer lugar.


   Seleccione una opcion moviendose con las flechas direccionales del teclado y presione enter para continuar

  ---->   1. Crear el archivo propiedades.dat
          2. Ingresar un nuevo inmueble
          3. Cargar/Mostrar Lista de propiedades
          4. Baja logica de una propiedad
          5. Buscar propiedad
          6. Salir

        Para ingresar los activos elegir la opcion 2 (del menu)
	Ejemplo de carga de un activo
	Ingrese el ID del articulo: 3
	Ingrese el mes: 3
	Ingrese el dia: 4

I	ingrese el año: 2023
	Ingrese la Zona del articulo:
	1- Capital Federal
	2- Bs.As. G.B.A. Zona Sur
	3- Bs.As. G.B.A. Zona Norte
	4- Bs.As. G.B.A. Zona Este
	5- Bs.As. G.B.A. Zona Oeste
	
	Ingrese la Ciudad del articulo: flores
	Ingrese la cantidad de Dormitorios del articulo: 3
	Ingrese la cantidad de baños del articulo: 2
	Ingrese la superficie total del articulo: 444
	Ingrese la superficie cubierta del articulo: 555
	Ingrese el precio del articulo: 500
	...
	En la opcion 3 (del menu)
	Has seleccionado la opcion 3 

	1.- Mostrar lista completa (Incluyendo Activos e Inactivos)
	2.- Mostrar solo los Activos
	3.- Mostrar por un Tipo especifico
	4.- Mostrar por un rango de tiempo
	Has seleccionado la opcion 4 (del menu)
	
	En la opcion 4 se pueden dar de baja un activo tanto por un error en la carga como por que ya no se utilice mas.
	ejemplo de baja logica

	ingrese el ID3 (cargado anteriormente)
	Usted dará de baja a:
	Zona: Capital Federal, Ciudad: flores, Dormitorios: 3, banios: 2, SuperficieT: 444.00,SuperficieC: 555.00, Precio: 500.00, Moneda: USD, Tipo: Departamento, Operacion: Alquiler
	Esta seguro de que quiere darla de baja? Ingrese 'S' para si o 'N' para no ingrese una opcion valida
	s
	***--El producto 3 se dio de baja correctamente--***
	Asi quedo la lista actualizada
	|ID   |ingreso     |Zona            |Ciudad     |Dormitorios  |Baños  |total     |cubierta  |Precio       |Moneda   |Tipo         |Operacion          |salida |Activo

	|2    |2/3/2023    |Capital Federal |san        |3            |2      |444.0     |555.0     |500.0        |USD      |Departamento |Alquiler           |       |1
	|22   |12/2/2023    |Bs.As.Zona Norte |cdss       |2            |3      |3333.0    |33.0      |3.0          |PESOS    |Casa         |Alquiler Temporal  |       |1


	5. Buscar propiedad(del menu)
	...
	4.- Dormitorios
	5.- Baños
	6.- total de la Superficie
	7.- cubierta de la Superficie
	8.- Precio
	9.- Moneda
	10.- Tipo
	11.- Operacion
	Ingrese el tipo de propiedad a buscar:
	
	6. Salir(termina el programa)

					Programa del menu anterior
...
//aqui se ingresan las zonas de las propiedades,ciudad,el tipo de moneda,el tipo de operacion,//
...
//Aqui se buscara el activo segun el tipo de opcion que estamos buscando//
...
//Menu que se imprime en pantalla con todos los activos cargados//
